# Picovoice SDK for Arduino boards - Vietnamese language
...
1. Compile and upload the `Picovoice_VN/GetUUID` sketch from the `File -> Examples` menu. Copy the UUID of the board
